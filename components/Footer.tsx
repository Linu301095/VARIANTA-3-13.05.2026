...
// Footerul are fundal închis pe toate variantele, deci foloseste peste tot logo-ul pentru fundal închis
const LOGO_DARK = (
  <Link href="/" aria-label="CalyHub — pagina principală" style={{ display: "inline-flex", alignItems: "center" }}>
    <Image src="/logo-dark.png" alt="CalyHub" width={44} height={44}
...
export default function Footer({ variant = "full", onAjutor }: { variant?: Variant; onAjutor?: () => void }) {
  // Footerul e închis la culoare pe toate variantele → aceeasi varianta de logo peste tot
