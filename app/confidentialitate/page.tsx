    ...
    <div style={{ minHeight: "100vh", background: "#FAFAFA", fontFamily: "'Nunito', system-ui, sans-serif", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1 }}>
        <section style={{ background: "#1A1A1A", padding: "56px 20px 48px", textAlign: "center" }}>
          <div style={{ display: "inline-block", background: "rgba(255,107,0,.15)", color: "#FF8C42", padding: "6px 18px", borderRadius: 50, fontSize: 12, fontWeight: 800, letterSpacing: 1.5, textTransform: "uppercase", marginBottom: 20, border: "1px solid rgba(255,107,0,.3)" }}>GDPR · Transparență</div>
          <h1 style={{ fontSize: "clamp(26px,4vw,42px)", fontWeight: 900, color: "#fff", marginBottom: 12 }}>Politica de Confidențialitate</h1>
