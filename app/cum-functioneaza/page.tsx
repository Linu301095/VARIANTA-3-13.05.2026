          ...
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 22 }}>
              {[
                ...
                { Icon: BellRing, title: "Alertă clienți inactivi", desc: "Asistentul AI calculează intervalul mediu de vizită pentru fiecare client și detectează când cineva a depășit acel interval cu mai mult de 20%. Primești o alertă clară în dashboard și un mesaj de reactivare gata redactat — tu decizi dacă îl trimiți pe WhatsApp sau SMS. Niciun client nu mai dispare în tăcere." },
